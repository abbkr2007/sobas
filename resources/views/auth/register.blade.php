<x-guest-layout>
   <section class="login-content">
      <div class="row m-0 align-items-start bg-white min-vh-100">
         
         <!-- Guidelines Column -->
         <div class="col-12 col-lg-6 d-flex justify-content-center align-items-start p-3 p-lg-5">
            <div class="w-100 p-4 p-lg-5 shadow-sm rounded guidelines-card" style="background-color: #ffffff; color: #333;">
               <!-- Heading -->
               <h5 class="fw-bold mb-4 text-primary text-center">Guidelines for Online Application</h5>

               <!-- Guidelines List -->
               <ol class="fs-6" style="line-height: 2; padding-left: 1.2rem;">
            ...
            <div class="w-100" style="max-width: 600px;">
               <div class="card shadow-lg border-0 rounded-3">
                  <div class="card-body p-4 p-md-5">
                     ...
                     <!-- Title Section -->
                     <a href="{{ route('dashboard') }}" class="d-flex align-items-center justify-content-center mt-2 text-decoration-none">
