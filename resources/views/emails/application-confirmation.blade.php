...
<body>
    <div class="confirmation">
        ...
        <div class="info">
            ...
            <p><strong>Date Submitted:</strong> {{ $application->created_at->format('F d, Y') }}</p>
        </div>
        <div class="footer">
            Thank you for applying to the School of Basic and Advanced Studies. We will contact you with further information.
        </div>
    </div>
</body>
</html>
